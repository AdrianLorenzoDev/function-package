...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_functions" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#314fc4dc#;
   pragma Export (C, u00001, "test_functionsB");
   ...
   u00082 : constant Version_32 := 16#53dc1241#;
   pragma Export (C, u00082, "functionsB");
   u00083 : constant Version_32 := 16#8817b0f2#;
   pragma Export (C, u00083, "functionsS");
   u00084 : constant Version_32 := 16#0dcf11d5#;
   pragma Export (C, u00084, "test_assertionsB");
   u00085 : constant Version_32 := 16#1487d8c5#;
   pragma Export (C, u00085, "test_assertionsS");
